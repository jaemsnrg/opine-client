...
export function Lights() {
  return (
    <>
      <spotLight color="#D66853" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="#F1F1F1" position={[-10, 0, 15]} intensity={0.8} />
    </>
  );
}
...
export function Sphere() {
  return (
    <motion.mesh position={[0, 0, 0]} variants={{ hover: { z: 2 } }}>
