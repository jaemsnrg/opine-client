...
const Header = () => {
  ...
  return (
    <header className="bg-[white] fixed z-30 top-8 left-[-1rem] right-0 z-50 bg-white bg-opacity-50 backdrop-filter backdrop-blur-md h-24 flex justify-between items-center ml-7 mr-3 md:mx-auto max-w-[65rem] rounded-lg drop-shadow-xl px-6 md:px-8">
      <TextLogo />
