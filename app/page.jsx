...
import ThreeDDisplay from "@/components/atoms/ThreeDDisplay";
        ...
        <Grid hasMarginTop={false} shadingBottom>
          <div className="relative z-10 col-start-0 col-span-6 md:col-start-1 md:col-span-5">
            <div className="w-full flex flex-col md:flex-row items-center gap-12 my-32">
              {/* <ThreeDDisplay /> */}
              <img
                className="shadow-xl w-3/5 md:w-80 rounded-md"
                src="/img/sphere.png"
              />
              <div className="w-full">
                <h2 className="t3 flex items-start text-dark-blue">Focussed</h2>
                <p className="b2">
                  We offer a selective range of simple, functional furniture.
                  Our focus on diligent design, care in craftsmanship, and
                  sustainable sourcing sets us apart.
                </p>
              </div>
            </div>
            <div className="w-full flex flex-col md:flex-row items-center gap-12 my-32">
              ...
              />
              <div className="w-full">
                <h2 className="t3 flex items-start text-dark-blue">
        ...
        <Grid>
          <div className="flex flex-col items-center justify-center col-start-0 col-span-6 md:col-start-2 md:col-span-4">
            <h2 className="t3s  text-center text-dark-blue">
              New items in our range are under development, leave your email and
              we'll keep you posted
            </h2>
            <div className="mt-12">
              <EmailForm
                onSubmit={(userEmail) => console.log("userEmail", userEmail)}
              />
            </div>
          </div>
        </Grid>
